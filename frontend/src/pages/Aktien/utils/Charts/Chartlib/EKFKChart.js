...
class EKFKChart extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      options: {
        ...
        xaxis: {
          categories: this.props.dataEKFK.myDataJahreEKFKJahre
        },
        yaxis: {
          labels: {
      ...
      series: [
        {
          name: "Gesamtkapital",
          data: this.props.dataEKFK.myDataGK, 
          // color: "#e4a4b7"
          color: "rgba(255,0,255,0.5)"
        },
        {
          name: "Fremdkapital",
          data: this.props.dataEKFK.myDataFK, 
          // color: "#e4a4b7"
          color: "rgba(0,255,255,0.5)"
        },
        {
          name: "Eigenkapital",
          data: this.props.dataEKFK.myDataEK, 
          // color: "#e4a4b7"
