...
class PegChart extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      options: {
        ...
        xaxis: {
          categories: this.props.dataPEG.myDataPEGJahre,
        },
        yaxis: {
          labels: {
          ...
          yaxis: [
            {
              ...
              label: {
                ...
                text: '⌀ ' + this.props.dataPEG.PEGAVG
              }
            },            
          ],
        },
      ...
      series: [
        {
            name: "PEG",
            data: this.props.dataPEG.myDataPEG, 
            // color: "#f0095b"
