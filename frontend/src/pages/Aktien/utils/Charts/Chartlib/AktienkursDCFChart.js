...
class AktienkursDCFChart extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      options: {
        ...
        xaxis: {
          categories: this.props.dataFairValueChart.FairValueChartJahre,
        },
        yaxis: {
          labels: {
      ...
      series: [
        {
          name: "Fair Value (DCF)",
          data: this.props.dataFairValueChart.FairValueChartDCF,
            ...
            color: "rgba(255,0,255,0.5)"
                  ...
                  {
                    name: "Aktienkurs",
                    data: this.props.dataFairValueChart.FairValueChartPrice,
          // color: "#f96b9e"
...
export default AktienkursDCFChart;