...
class CashDebtChart extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      options: {
        ...
        xaxis: {
          categories: this.props.dataCashDebt.myDataCashDebtJahre,
        },
        yaxis: {
          labels: {
      ...
      series: [
        {
          ...
          data: this.props.dataCashDebt.myDataTotalDebt,
          // color: "#e4a4b7"
          color: "rgba(255,0,255,0.5)"
        },
        {
          name: "Cash und Investments",
          data: this.props.dataCashDebt.myDataCashAndShortTermInvestments,
        ...
        {
          name: "Cash",
          data: this.props.dataCashDebt.myDataCashAndCashEquivalents,
