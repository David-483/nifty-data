...
class FCFOEChart extends Component {
  constructor(props) {
    super(props);
    this.state = {
      options: {
        ...
        xaxis: {
          categories: this.props.dataFCFOE.myDataJahreOE
        },
        yaxis: {
          labels: {
      ...
      series: [
        {
            name: "Free Cashflow",
            data: this.props.dataFCFOE.myDatafreeCashFlow,
            // color: "#f0095b"
            color: "rgba(255,0,255,0.5)"
          },
                  {
          name: "Owner Earnings",
          data: this.props.dataFCFOE.myDataOwnearEarnings,
          // color: "#f96b9e"
